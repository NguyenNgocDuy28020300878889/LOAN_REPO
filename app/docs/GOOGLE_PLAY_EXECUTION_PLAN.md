...
| --- | -------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P0  | **Đã đóng trên local, CI và STAGING**        | Migration `20260923090000_create_loan_contract.sql` xóa hai overload cũ và tạo một function duy nhất với email tùy chọn có default. Local đạt replay sạch 21 migrations, 141 SQL assertions và 4 concurrency scenarios. GitHub CI run `35837096936` xanh; dry-run STAGING chỉ có migration này, triển khai thành công và regression strict 16 assertions đạt trong transaction rollback.       | Giữ regression trong CI; tiếp tục nghiệm thu native hai thiết bị trước khi build artifact phát hành.                                                       |
...
Bước 2 chưa hoàn tất trên native: chưa có bằng chứng hai thiết bị Android cho Google callback, chấp nhận/từ chối lời mời, hết hạn/thu hồi/cấp lại, bàn phím, cold/warm link, foreground/reconnect và push.
