...
- Hermes Android export đạt và chứa mã PKCE mới. Chưa có thiết bị/AVD để chạy native hoặc APK mới để đối chiếu manifest thực tế. Việc tạo APK EAS từ commit này còn chờ chấp thuận tải source dự án lên dịch vụ EAS; kết quả local/CI không thay thế kiểm thử bản cài.
